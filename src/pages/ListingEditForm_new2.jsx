...
const EditListingForm = ({ listing, locations, developers, agents, authToken }) => {
  ...
  useEffect(() => {
    ...
    if (listing) {
      ...
      if (listing.photos && listing.photos.length > 0) {
        setPhotos(listing.photos.map(photo => ({
          id: photo.id,
  ...
  const formGroups = {
    basicInfo: ['reference_no', 'title', 'title_deed', 'property_type', 'offering_type', 'status'],
    propertyDetails: ['size', 'unit_no', 'bedrooms', 'bathrooms', 'parking', 'furnished', 'total_plot_size', 
                      'built_up_area', 'layout_type', 'project_name', 'project_status', 'build_year'],
    pricing: ['price', 'payment_method', 'financial_status', 'financial_status_id', 'rental_period', 
              'emirate_amount', 'payment_option', 'no_of_cheques', 'contract_charges'],
    dates: ['available_from', 'rera_issue_date', 'rera_expiration_date', 'contract_expiry_date', 'contract_expiry'],
    permits: ['rera_permit_number', 'dtcm_permit_number'],
    descriptions: ['title_en', 'title_ar', 'desc_en', 'desc_ar'],
    additional: ['geopoints', 'listing_owner', 'landlord_name', 'landlord_contact', 'customer', 
                'sale_type', 'sale_type_1', 'availability', 'watermark'],
    relations: ['pf_location', 'developer_id', 'agent_id', 'company_id'],
    visibility: ['pf_enable', 'bayut_enable', 'dubizzle_enable', 'website_enable']
  };
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="bg-blue-600 p-6">
            <h1 className="text-2xl font-bold text-white">Edit Listing: {listing?.title || 'Property'}</h1>
            <p className="text-blue-100 mt-1">Reference: {listing?.reference_no}</p>
          </div>
          
          {success && (
            <div className="bg-green-100 border-l-4 border-green-500 text-green-700 p-4 mb-6 mx-6 mt-6">
              <p className="font-medium">Success! The listing has been updated.</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="p-6">
            {/* Photos Section */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Property Photos</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  ...
                  <div key={photo.id} className="relative group border rounded-lg overflow-hidden">
                    ...
                    <div className="absolute top-2 right-2 flex space-x-2">
                      <button
                        ...
                        className={`p-1 rounded-full ${photo.is_main ? 'bg-green-500 text-white' : 'bg-white text-gray-600 hover:bg-blue-100'}`}
                      >
                        <CheckCircle size={20} />
                      </button>
                      <button
                ...
                <div className="border rounded-lg border-dashed border-gray-300 h-48 flex items-center justify-center hover:bg-gray-50 cursor-pointer">
                  <div className="text-center">
                    ...
                    <span className="mt-2 block text-sm font-medium text-gray-600">Add Photo</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Number of Cheques</label>
                  <input
                    type="number"
                    name="no_of_cheques"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Contract Charges</label>
                  <input
                    type="number"
            ...
            {/* Permits & Dates */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Permits & Dates</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
            ...
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Property Descriptions</h2>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Sale Type 1</label>
                  <input
                    type="text"
                    name="sale_type_1"
            ...
            {/* Visibility Options */}
            <div className="mb-8">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Visibility Options</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="pf_enable" className="ml-2 block text-sm text-gray-700">
                    PF Enable
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="bayut_enable" className="ml-2 block text-sm text-gray-700">
                    Bayut Enable
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="dubizzle_enable" className="ml-2 block text-sm text-gray-700">
                    Dubizzle Enable
                  </label>
                </div>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <label htmlFor="website_enable" className="ml-2 block text-sm text-gray-700">
                    Website Enable
                  </label>
                </div>
              </div>
