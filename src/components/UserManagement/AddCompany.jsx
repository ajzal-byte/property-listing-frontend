  ...
  useEffect(() => {
    const fetchUsers = async () => {
      ...
      try {
        ...
        const response = await fetch('https://backend.myemirateshome.com/api/unassociatedadmins',  {
            method: 'GET',
            headers: {
    ...
    setUsers(users.sort((a, b) => new Date(b.created_at) - new Date(a.created_at)));
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm">
      <div className="w-full max-w-[60%] mx-auto p-6 bg-white rounded-lg shadow-md relative z-10">
        <h2 className="text-2xl font-bold mb-6 text-gray-800">Company Registration</h2>
        ...
        <div className="space-y-4">
          <div className="mb-4">
            ...
            <input
              ...
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 
                ${errors.name ? 'border-red-500 focus:ring-red-200 bg-red-50' : 
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 
                ${errors.email ? 'border-red-500 focus:ring-red-200 bg-red-50' : 
                'border-gray-300 focus:ring-blue-200 bg-white'}
                text-gray-900`}
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 
                ${errors.phone ? 'border-red-500 focus:ring-red-200 bg-red-50' : 
                'border-gray-300 focus:ring-blue-200 bg-white'}
                text-gray-900`}
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 
                ${errors.website ? 'border-red-500 focus:ring-red-200 bg-red-50' : 
                'border-gray-300 focus:ring-blue-200 bg-white'}
                text-gray-900`}
          ...
          <div className="mb-6">
            ...
            <div className="relative mb-2">
              ...
              >
                <span className={isAdminsLoading ? "text-gray-400" : ""}>
                  {isAdminsLoading ? "Loading users..." : "Select administrator to add"}
                </span>
            ...
            <div className="mt-2 space-y-2">
              {formData.admins.map((admin, index) => (
                <div key={admin} className="flex items-center justify-between p-2 bg-gray-100 rounded">
              ...
              {formData.admins.length === 0 && (
                <p className="text-gray-500 text-sm italic">No administrators added</p>
              )}
            </div>
          </div>
