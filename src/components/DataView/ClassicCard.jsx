...
import { 
  Heart, BedDouble, Bath, Home, Ruler, Calendar, 
  CheckCircle, Tag, MapPin, Building, Phone, Mail, 
  DollarSign, User, Shield, ChevronRight
} from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="relative md:w-1/3 h-64">
          ...
          <button className="absolute top-4 right-4 bg-white rounded-full p-2 shadow-md transition transform hover:scale-110">
            <Heart className={`h-5 w-5 ${isHovered ? 'text-red-500' : 'text-blue-600'}`} />
          </button>
          ...
          <div className="flex flex-col h-full">
            <div className="flex justify-between items-start mb-2">
              <div>
                <div className="flex items-center space-x-2 mb-1">
                  ...
                  <span className={`${property_type === "Apartment" ? "bg-green-100 text-green-800" : "bg-purple-100 text-purple-800"} px-3 py-1 rounded-full text-sm font-medium`}>
                    {property_type}
                  </span>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex items-center text-gray-700">
                ...
                <span>RERA Valid until: {formatDate(rera_expiration_date)}</span>
              </div>
            </div>
              ...
              <div className="flex flex-wrap justify-between items-center">
                ...
                {agent && (
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      {agent.rera_number && (
                        <p className="text-xs text-gray-500">RERA: {agent.rera_number}</p>
                      )}
                    </div>
                  </div>
                )}
                ...
                {company && company.name && (
                  <div className="flex items-center mt-2 md:mt-0">
                    <span className="text-xs text-gray-500 mr-2">{company.name}</span>
                    {company.logo_url && (
                      <img 
